...
class vistasModelo{
    ...
    protected static function obtener_vistas_modelo($vistas){
        ...
        ,"agregar-personal","listar-rol","listar-personal","listar-actividadQrsAll","listar-actividadPendienteAll","listar-actividadPendiente","agregar-actividadQRS","agregar-actividadesQRSALL","listar-actividadesQRSU","listar-actividadAtendidasAll","listar-actividadAtendidasU"];
