...
class vistasModelo{
    ...
    protected static function obtener_vistas_modelo($vistas){
        ...
        ,"editar-rol","ver-rol","ver-personal","editar-personal","ver-actividadAtendidaU","editar-actividadAtendidaU","ver-actividadU","editar-actividadU","ver-actividadAtendidaAll","editar-actividadAtendidaAll","perfil","listar-excel","graficos","buscar-caso","buscar-actividadqrsAll","graficosAtendidosALL","graficosAtendidosU","graficosPendientesALL","graficosPendientesU","graficosU","ver-personal-general"];
