...
<h6>
<p><strong>Estado: </strong> <?php if($campos['ACTestado']=="10")
                                {
                      ...
                      <div class="product_social">
                        <ul class="list-inline display-layout">
                          ...
                          <a href="<?php echo SERVERURL?>listar-actividadPendienteAll/" class="btn btn-round btn-danger btn-sm"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                </a>
