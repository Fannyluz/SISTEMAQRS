                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <h2>UPTvirtual <small>Editar Actividad QRS U</small></h2>
                                    ...
                                    <select class="form-control" name="tipousuario_up">
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                    <a href="<?php echo SERVERURL?>listar-actividadesQRSU/" class="btn btn-round btn-danger"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                                        </a>
