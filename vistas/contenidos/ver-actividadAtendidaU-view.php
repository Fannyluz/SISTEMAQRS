          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Información detallada de la actividad Atendidas</h2>
...
<p><strong>Estado: </strong> <?php if($campos['ACTestado']=="10")
                      ...
                      <div class="product_social">
                        <ul class="list-inline display-layout">
                          ...
                          <a href="<?php echo SERVERURL?>listar-actividadAtendidasU/" class="btn btn-round btn-danger btn-sm"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                </a>
