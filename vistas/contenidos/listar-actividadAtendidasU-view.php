                    ...
                    <p align="right">
                        ...
                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                $datos=$casos->listar_ActividadQrsAtendidasU_controlador();
                                $count=1;
                                $nuevoestado="Activo";
...
?>
                                <a href="<?php echo SERVERURL?>ver-actividadAtendidaU/<?php echo $principal->encryption($row['ACTcodigo']) ?>" class="btn btn-round btn-outline-primary btn-sm"><i class="fa fa-eye fa-sm"></i> 
                                </a>

                                <a href="<?php echo SERVERURL?>editar-actividadAtendidaU/<?php echo $principal->encryption($row['ACTcodigo']) ?>" class="btn btn-round btn-outline-info btn-sm"><i class="fa fa-pencil fa-sm"></i>
                                </a>            
