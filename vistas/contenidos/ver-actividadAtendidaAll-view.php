                    ...
                    <div class="col-md-5 col-sm-5 " style="border:0px solid #e5e5e5;">
                      ...
                      <div class="">
                        ...
                        <div class="product_price">
                         ...
                         <h6><strong>Estado:</strong> <?php if($campos['ACTestado']=="10")
                                {
                          ...
                          <h6><strong>Acciones:</strong><?php echo $campos['ACTacciones']?></h6>
                          <br>
                        </div>
                      </div>
                      ...
                      <div class="product_social">
                        <ul class="list-inline display-layout">
                          ...
                          <a href="<?php echo SERVERURL?>listar-actividadAtendidasAll/" class="btn btn-round btn-danger btn-sm"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                </a> 
