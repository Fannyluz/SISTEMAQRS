                      ...
                      <div class="">
                        ...
                        <div class="product_price">
                          ...
                          <p><strong>Facultad:</strong> </p> <?php if($campos['ACTfacultad']=="0")
                                ...
                                {
                                     ?> <h5> <label class="badge bg-primary" style="background-color:#9A6B;color:yellow;"><?php echo $nuevoestado = "FAING"; ?></label></h5>
                                    <?php
                                }
...
<h6>
                      ...
                      <div class="product_social">
                        <ul class="list-inline display-layout">
                          ...
                          <a href="<?php echo SERVERURL?>listar-actividadesQRSU/" class="btn btn-round btn-danger btn-sm"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                </a>
