                                   ...
                                   <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/TipoUsuarioAjax.php" method="POST" data-form="save" novalidate>
                                       ...
                                       <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea class="form-control" data-validate-length-range="3" name="tipousuario_descripcion_reg" id="tipousuario_descripcion" placeholder="Ingrese la descripción" required="required"></textarea>
