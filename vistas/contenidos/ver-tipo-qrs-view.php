          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Información detallada del tipo QRS</h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-5 col-sm-5 " style="border:0px solid #e5e5e5;">
                      ...
                      <h3 class="prod_title"><b><?php echo $campos['TIPnombre']?></b></h3>
                      ...
                      <div class="product_social">
                        <ul class="list-inline display-layout">
                          ...
                          <a href="<?php echo SERVERURL?>listar-tipo-qrs/" class="btn btn-round btn-danger btn-sm"><i class="fa fa-mail-reply fa-sm"></i> Atras
                                </a>
