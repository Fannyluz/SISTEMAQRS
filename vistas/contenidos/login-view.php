  ...
  <div class="login_wrapper">
    <div class="animate form login_form">
      ...
      <form action="" method="POST" autocomplete="off" >
        ...
        <div><input type="text" class="form-control" id="UserName" name="usuario_log" pattern="[a-zA-Z0-9]{1,35}" maxlength="35" required="" ></div>
        <div><input type="password" class="form-control" id="UserPassword" name="clave_log" pattern="[a-zA-Z0-9$@.-]{7,100}" required="" ></div>
        <button type="submit" class="btn btn-" style="background-color:#10226a;color:white;">Acceder</button>
        <br>
        <a  href=" <?php echo SERVERURL?>vistas/contenidos/reset.php/"> ¿Olvidaste tu Contraseña?</a>
              <div class="separator">
                <div>
