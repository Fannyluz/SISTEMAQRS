...
<div class="right_col" role="main">
                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_title" style="color:#10226a;">
                                    <h2>UPTvirtual <small>Lista de Actividades QRS Atendidas</small></h2> 
 ...
 <div class="col-sm-12">
    ...
    <input type="hidden" name="export" value="export" />    
        ...
        <a href="<?php echo SERVERURL?>graficosAtendidos/" class="btn btn-round btn-sm" style="background-color:#10226a;color:white;">
      ...
      <p align="right">
                        ...
                        <table id="datatable" class="table table-hover table-condensed table-bordered border-warning" style="width:100%" >
                            ...
                            <tbody>
                                ...
                                $datos=$casos->listar_ActividadQrsAtendidasAll_controlador();
                                $count=1;
                                $nuevoestado="Activo";
...
?>
                                <a href="<?php echo SERVERURL?>ver-actividadAtendidaAll/<?php echo $principal->encryption($row['ACTcodigo']) ?>" class="btn btn-round btn-outline-primary btn-sm"><i class="fa fa-eye fa-sm"></i> 
                                </a>

                                <a href="<?php echo SERVERURL?>editar-actividadAtendidaAll/<?php echo $principal->encryption($row['ACTcodigo']) ?>" class="btn btn-round btn-outline-info btn-sm"><i class="fa fa-pencil fa-sm"></i>
                                </a>            
