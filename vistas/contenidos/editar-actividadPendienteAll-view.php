...
$datos_caso= $ins_caso->Ver_ActividadesQrsPendientesALL_controlador($pagina[1]);
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <h2>UPTvirtual <small>Editar Actividad QRS Pendiente</small></h2>
                                ...
                                <div class="field item form-group">
                                   <label class="col-form-label col-md-3 col-sm-3  label-align"><b>Tipo Emisor:</b><span class="required">*</span></label>
                                    ...
                                    <select class="form-control" name="tipousuario_up">
                                        ...
                                        <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align"><b>Acciones:</b><span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
                                        <textarea class="form-control" name="ACTacciones_up" id="ACTacciones_up" placeholder="Ingrese las acciones realizadas" required="required"><?php echo $campos['ACTacciones']?></textarea>
                                        </div>
                                        </div>
