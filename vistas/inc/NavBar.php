                ...
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  ...
                  <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item"  href="javascript:;" style="color:#10226a;"> Perfil</a>
                      <a class="dropdown-item"  href="javascript:;" style="color:#10226a;">
                        <span class="badge bg-red pull-right" >50%</span>
                        <span>Configuraciones</span>
                      </a>
                  <a class="dropdown-item"  href="javascript:;" style="color:#10226a;">Ayuda</a>
                    <a class="dropdown-item"  href="login.html" style="color:#10226a;"><i class="fa fa-sign-out pull-right" style="color:#10226a;"></i> Cerrar Sesion</a>
                  </div>
                </li>

                <li role="presentation" class="nav-item dropdown open">
                  <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false" >
                    <i class="fa fa-envelope-o" style="color:#10226a;"></i>
                    <span class="badge bg-green" style="color:#10226a;">6</span>
                  </a>
